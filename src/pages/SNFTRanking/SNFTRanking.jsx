import SNFTRanking_ls from './SNFTRanking.less';
...
export default function SNFTRanking() {
    const data1 = [
    ...
    return (
        <>
            <div className={SNFTRanking_ls.RankingBox}>
                <div className={SNFTRanking_ls.RankingSNFTBox}>
                    <div className={SNFTRanking_ls.RankingSNFTTitle}>
                        <ul>SNFT排行</ul>
                        <div className={SNFTRanking_ls.RankingSNFTButton}>
                            <Radio.Group
                                value={size}
                                onChange={onChangeSNFT}
                                className={
                                    SNFTRanking_ls.RankingSNFTButtonGroup
                                }
                                style={{
                                    marginBottom: 24,
                                }}
