        ...
        <>
            <div className={ComingSoon404_ls.ComingSoon404Box}>
                ...
                <p className={ComingSoon404_ls.ComingSoon404Box_text2}>
                    Oops! The search string you entered was: “xxxxxx” Sorry!
                    This is an invalid search string.
                </p>
                <div className={ComingSoon404_ls.HeaderBox_SearchBox}>
                    <div
                        className={
                            ComingSoon404_ls.HeaderBox_SearchBox_inputBox
                        }
                        id="headerselect"
                    >
                        {/* <Select
                        ...
                        <input
                            ...
                            className={
                                ComingSoon404_ls.HeaderBox_SearchBox_inputBox_input
                            }
                            id="homepageinput"
                        />
                    </div>
                    <div
                        className={ComingSoon404_ls.HeaderBox_Search}
