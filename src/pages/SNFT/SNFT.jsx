            ...
            title: () => (
                <div className={SNFT_ls.tablexbox2}>
                    ...
                    <Tooltip
                        ...
                        title={() => {
                            return (
                                <div className={SNFT_ls.tablexbox2_Period}>
                                    <p>
                        ...
                        color="#4D4D55"
                    >
                        <span className={SNFT_ls.tablexbox2_icon}>
                            <QuestionCircleOutlined />
                        </span>
                    </Tooltip>
                </div>
                ...
                <span>
                    ...
                    {text.length >= 40 ? (
                        <Tooltip title="L2" color="#4D4D55">
                            <span
                                className={SNFT_ls.SNFTBox_tablelevelCollection}
                            >
        ...
        <>
            <div className={SNFT_ls.SNFTBox}>
                ...
                <div className={SNFT_ls.SNFTBox_table} id="SNFTTable">
                    <p className={SNFT_ls.SNFTBox_table_title}>SNFT</p>
                    <Table
                        columns={columns}
