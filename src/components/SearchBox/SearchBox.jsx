    ...
    return (
        <>
            <div className={SearchBox_le.SearchBox}>
                <div className={SearchBox_le.SearchBox_SearchBox_inputBox} id='SearchBoxselect'>
                    <Select
                        ...
                        className={SearchBox_le.SearchBox_SearchBox_inputBox_select}
                        >
                            <Option value="AllFilters">All Filters</Option>
                    </Select>
                    <input placeholder='Search by Address / Txn Hash / Block / Token' className={SearchBox_le.SearchBox_SearchBox_inputBox_input} id='homepageinput' />
                </div>
                <div className={SearchBox_le.SearchBox_Search} onClick={homepageinputclick}>
                    <BsSearch/>
                </div>
            </div>
        </>
