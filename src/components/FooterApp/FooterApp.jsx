                ...
                <div className={FooterApp_ls.FooterAppBox_center}>
                    ...
                    <div className={FooterApp_ls.FooterBox_textBox_left_imgbox}>
                        <Tooltip title="Blockchain Twitter">
                            <div onClick={twitter} className={FooterApp_ls.FooterBox_textBox_left_img1}/>
                        </Tooltip>
                        ...
                        <Tooltip title="Instagram">
                            <div onClick={ins} className={FooterApp_ls.FooterBox_textBox_left_img3}/> 
                        </Tooltip>
                        <Tooltip title="Discord">
                            <div onClick={discord} className={FooterApp_ls.FooterBox_textBox_left_img4} /> 
                        </Tooltip>
                        <Tooltip title="Telegram">
                            <div onClick={Telegram} className={FooterApp_ls.FooterBox_textBox_left_img5} />
                        </Tooltip>
                        <Tooltip title="Github">
                            <div onClick={github} className={FooterApp_ls.FooterBox_textBox_left_img6} /> 
                        </Tooltip>
                        <Tooltip title="Medium">
                            <div onClick={medium} className={FooterApp_ls.FooterBox_textBox_left_img7} />
                        </Tooltip>
                        <Tooltip title="YouTube">
                            <div onClick={Youtube} className={FooterApp_ls.FooterBox_textBox_left_img8} />
                        </Tooltip>
                    </div>
                    <div className={FooterApp_ls.FooterBox_textBox_right}>
                        <ul className={FooterApp_ls.FooterBox_textBox_right_ul}>
                            <li className={FooterApp_ls.FooterBox_textBox_right_ul_lititle}>
                            About Us
                            </li>
                            <li onClick={AboutWormholesBlockchain} className={FooterApp_ls.FooterBox_textBox_right_ul_li}>
                            About Wormholes Blockchain
                            </li>
                            <li onClick={WormholesOfficialWebsite} className={FooterApp_ls.FooterBox_textBox_right_ul_li}>
                        ...
                        <ul className={FooterApp_ls.FooterBox_textBox_right_ul}>
                            ...
                            <li onClick={NFTMarketplaceTutorial} className={FooterApp_ls.FooterBox_textBox_right_ul_li}>
                            NFT Marketplace Tutorial
                            </li>
                            <li onClick={OneClickNFTMarketplace} className={FooterApp_ls.FooterBox_textBox_right_ul_li}>
                        ...
                        <ul className={FooterApp_ls.FooterBox_textBox_right_ul}>
                            ...
                            <li onClick={wiki} className={FooterApp_ls.FooterBox_textBox_right_ul_li}>
                            Wormholes Technology Wiki
                            </li>
                            {/* <li onClick={download} className={FooterApp_ls.FooterBox_textBox_right_ul_li}>
                            Wormholes Whitepaper
                            </li> */}
                            <li onClick={WormholesWallet} className={FooterApp_ls.FooterBox_textBox_right_ul_li}>
