            ...
            <div className={Footer_ls.FooterBox}>
                ...
                <div className={Footer_ls.FooterBox_textBox}>
                    <div className={Footer_ls.FooterBox_textBox_left}>
                        ...
                        Wormholes Scan is a Block Explorer and Analytics Platform for Wormholes
                        </p>
                        <div className={Footer_ls.FooterBox_textBox_left_imgbox}>
                            <Tooltip title="Blockchain Twitter">
                                <div onClick={twitter} className={Footer_ls.FooterBox_textBox_left_img1}/>
                            </Tooltip>
                            ...
                            <Tooltip title="Instagram">
                                <div onClick={ins} className={Footer_ls.FooterBox_textBox_left_img3}/> 
                            </Tooltip>
                            <Tooltip title="Discord">
                                <div onClick={discord} className={Footer_ls.FooterBox_textBox_left_img4} /> 
                            </Tooltip>
                            <Tooltip title="Telegram">
                                <div onClick={Telegram} className={Footer_ls.FooterBox_textBox_left_img5} />
                            </Tooltip>
                            <Tooltip title="Github">
                                <div onClick={github} className={Footer_ls.FooterBox_textBox_left_img6} /> 
                            </Tooltip>
                            <Tooltip title="Medium">
                                <div onClick={medium} className={Footer_ls.FooterBox_textBox_left_img7} />
                            </Tooltip>
                            <Tooltip title="YouTube">
                                <div onClick={Youtube} className={Footer_ls.FooterBox_textBox_left_img8} />
                            </Tooltip>
                        </div>
                    ...
                    <div className={Footer_ls.FooterBox_textBox_right}>
                        <ul className={Footer_ls.FooterBox_textBox_right_ul}>
                            <li className={Footer_ls.FooterBox_textBox_right_ul_lititle}>
                            About Us
                            </li>
                            <li onClick={AboutWormholesBlockchain} className={Footer_ls.FooterBox_textBox_right_ul_li}>
                            About Wormholes Blockchain
                            </li>
                            <li onClick={WormholesOfficialWebsite} className={Footer_ls.FooterBox_textBox_right_ul_li}>
                        ...
                        <ul className={Footer_ls.FooterBox_textBox_right_ul}>
                            ...
                            <li onClick={NFTMarketplaceTutorial} className={Footer_ls.FooterBox_textBox_right_ul_li}>
                            NFT Marketplace Tutorial
                            </li>
                            <li onClick={OneClickNFTMarketplace} className={Footer_ls.FooterBox_textBox_right_ul_li}>
                        ...
                        <ul className={Footer_ls.FooterBox_textBox_right_ul}>
                            ...
                            <li onClick={wiki} className={Footer_ls.FooterBox_textBox_right_ul_li}>
                            Wormholes Technology Wiki
                            </li>
                            {/* <li onClick={download} className={Footer_ls.FooterBox_textBox_right_ul_li}>
                            Wormholes Whitepaper
                            </li> */}
                            <li onClick={WormholesWallet} className={Footer_ls.FooterBox_textBox_right_ul_li}>
                            Wormholes Wallet & Tutorial
                            </li>
                        </ul>
                    </div>
                </div>
